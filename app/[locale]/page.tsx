      ...
      <Background fade>
        <div className='py-20'>
          <section className='relative flex items-center justify-center xl:justify-between xl:px-24'>
            ...
            <aside>
              <div className='text-right text-2xl font-extrabold'>
                ...
                <div className='absolute -top-[20px] right-0 hidden h-[2px] w-96 bg-milky-white md:block xl:top-[15px]'></div>
              </div>
          ...
          <div className='mt-5 hidden md:block'>
            <div className='h-[2px] w-96 bg-milky-white'></div>
            <div className='ml-12 mt-2 h-[5px] w-9 bg-milky-white'></div>
          </div>
